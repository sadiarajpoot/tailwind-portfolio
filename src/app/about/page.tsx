...
function About() {
  return (
    <div className="text-center pt-9 absolute top-30 left-0 w-full max-h-max bg-gradient-to-b from-blue-100 via-pink-100 to-yellow-200 z-0">
    <h2 className="pt-[110px] text-5xl font-bold mb-9 text-[#01455E] ">About <span className='text-[#E1aD01]'> Me</span> </h2>
